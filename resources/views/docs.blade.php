                                    ...
                                    <div class="mb-6 sm:mt-0 absolute bottom-0 xl:static">
                                        <div class="xl:-mr-24 p-3 sm:p-6 flex sm:inline-flex xl:flex space-x-2 rounded-lg border dark:border-none relative bg-white dark:bg-dark-500 shadow-xl z-[1]">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="mt-2 sm:mt-4 mr-1 sm:mr-0 text-sm sm:text-md text-gray-900 dark:text-gray-100">Let's build something with Turbo Laravel!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <img src="{{ asset('/images/intro-code-showcase.png') }}" alt="Example Code" class="hidden xl:block rotate-3 rounded-md w-[450px]">
                        </div>
                    @endif
